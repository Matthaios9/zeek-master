...
int Manager::GetValueLength(const Value* val) const {
    ...
    switch ( val->type ) {
        ...
        case TYPE_PATTERN: {
            ...
            length += sizeof(val->val.pattern_val.is_case_insensitive);
            length += sizeof(val->val.pattern_val.is_single_line);
            break;
        }
    ...
    switch ( val->type ) {
        ...
        case TYPE_PATTERN: {
            ...
            memcpy(data + startpos + length, &val->val.pattern_val.is_case_insensitive,
                   sizeof(val->val.pattern_val.is_case_insensitive));
            length += sizeof(val->val.pattern_val.is_case_insensitive);
            memcpy(data + startpos + length, &val->val.pattern_val.is_single_line,
                   sizeof(val->val.pattern_val.is_single_line));
            length += sizeof(val->val.pattern_val.is_single_line);
            return length;
        }
