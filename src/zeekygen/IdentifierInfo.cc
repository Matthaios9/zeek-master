...
void IdentifierInfo::AddRecordField(const TypeDecl* field, const string& script, vector<string>& comments,
                                    bool from_redef) {
...
vector<string> IdentifierInfo::GetComments() const { return comments; }
