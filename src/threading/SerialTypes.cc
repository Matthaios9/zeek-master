...
Value::Value(const Value& other) {
    ...
    switch ( other.type ) {
        ...
        case TYPE_PATTERN: {
            val.pattern_val.text = util::copy_string(other.val.pattern_val.text);
            val.pattern_val.is_case_insensitive = other.val.pattern_val.is_case_insensitive;
            val.pattern_val.is_single_line = other.val.pattern_val.is_single_line;
            break;
        }
        case TYPE_TABLE: {
