...
RADIUS_Analyzer::~RADIUS_Analyzer() { delete interp; }

void RADIUS_Analyzer::Done() { Analyzer::Done(); }

void RADIUS_Analyzer::DeliverPacket(int len, const u_char* data, bool orig, uint64_t seq, const IP_Hdr* ip,
                                    int caplen) {
