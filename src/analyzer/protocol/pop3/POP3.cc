...
void POP3_Analyzer::ProcessClientCmd() {
    ...
    switch ( cmd_code ) {
        ...
        case detail::POP3_CMD_OK: Weird("pop3_client_sending_server_commands"); break;
            ...
            if ( masterState == detail::POP3_AUTHORIZATION ) {
                ...
                if ( ! *message ) {
                    ...
                    if ( strstr(message, "LOGIN") )
                        ...
                        state = detail::AUTH;
                        POP3Event(pop3_unexpected, true, cmd, util::fmt("unknown AUTH method %s", message));
                    }
        ...
        default: reporter->AnalyzerError(this, "unknown POP3 command"); return;
    }
}
    ...
    switch ( cmd_code ) {
        case detail::POP3_CMD_OK:
            ...
            if ( guessing ) {
                ...
                guessing = false;
                state = lastState;
                POP3Event(pop3_unexpected, false, cmd, "no auth required -> state changed to 'transaction'");
            }

            switch ( state ) {
                case detail::START: masterState = detail::POP3_AUTHORIZATION; break;
        ...
        case detail::POP3_CMD_ERR:
            ...
            switch ( state ) {
                ...
                case detail::UIDL:
                case detail::TOP:
                case detail::XSENDER: masterState = detail::POP3_TRANSACTION; break;

                case detail::CAPA: break;
        ...
        default: Weird("pop3_server_sending_client_commands"); break;
    }
}
...
void POP3_Analyzer::POP3Event(const EventHandlerPtr& event, bool is_orig, const char* arg1, const char* arg2) {
    ...
    Args vl;
    vl.reserve(2 + static_cast<bool>(arg1) + static_cast<bool>(arg2));
